      ...
      textBrowser(new QTextBrowser(this)),dialogSettingsNetwork(new DialogSettingsNetwork(this))
{
    ...
    auto vLabelSpinBox_X = new VLabelSpinBox("X");
    auto vLabelSpinBox_Y = new VLabelSpinBox("Y");
    auto vLabelSpinBox_V = new VLabelSpinBox("V");
    auto vLabelSpinBox_M = new VLabelSpinBox("M");
    auto vLabelSpinBox_S = new VLabelSpinBox("S");
    auto vLabelSpinBox_P = new VLabelSpinBox("P");

    //create vLabelDoubleSpinBox_A
    auto vLabelDoubleSpinBox_A = new VLabelDoubleSpinBox("A");
